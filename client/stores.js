export const STORES = {
	"Kung Fu Tea": {
		"name" : "Kung Fu Tea",
		"toppings" : [
			{"name" : "Bubbles", "price" : 0.50},
			{"name" : "Nata Jelly", "price" : 0.50},
			{"name" : "Red Bean", "price" : 0.50},
			{"name" : "Mung Bean", "price" : 0.50},
			{"name" : "Herbal Jelly", "price" : 0.50},
		...
		"menu" : [
			...
			},
			{
				...
				"items" : [
					...
					{
						"name" : "Strawberry Lemon Green Tea",
						"sizes" : [
							{"name" : "Medium", "price" : 3.75},
							{"name" : "Large", "price" : 4.75}
						]
